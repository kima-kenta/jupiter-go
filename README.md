...
[![GoDoc](https://pkg.go.dev/badge/github.com/kima-kenta/jupiter-go?status.svg)](https://pkg.go.dev/github.com/kima-kenta/jupiter-go?tab=doc)
[![Go Report Card](https://goreportcard.com/badge/github.com/kima-kenta/jupiter-go)](https://goreportcard.com/report/ilkamo/jupiter-go)
...
```bash
go get github.com/kima-kenta/jupiter-go
```
